...
"""
    ...
    historical = financials["historical_financials"]
    growth = financials["growth_metrics"]
    profitability = financials["profitability"]
    cash = financials["cash_quality"]
    balance = financials["balance_sheet_quality"]
    verdict = financials["eios_financial_verdict"]
...
PAT: {historical["pat"]}
Operating Cash Flow: {historical["operating_cash_flow"]}
Free Cash Flow: {historical["free_cash_flow"]}
Net Debt: {historical["net_debt"]}


GROWTH METRICS

Revenue CAGR 3Y: {growth["revenue_cagr_3y"]}
Revenue CAGR 5Y: {growth["revenue_cagr_5y"]}
PAT CAGR 3Y: {growth["pat_cagr_3y"]}
PAT CAGR 5Y: {growth["pat_cagr_5y"]}


PROFITABILITY

EBITDA Margin: {profitability["ebitda_margin"]}
PAT Margin: {profitability["pat_margin"]}
...
CFO to PAT: {cash["cfo_to_pat"]}
Free Cash Flow Quality: {cash["free_cash_flow_quality"]}
Working Capital Assessment: {cash["working_capital_assessment"]}


BALANCE SHEET QUALITY

Debt to Equity: {balance["debt_to_equity"]}
Net Debt to EBITDA: {balance["net_debt_to_ebitda"]}
Interest Coverage: {balance["interest_coverage"]}
Assessment: {balance["assessment"]}


EIOS FINANCIAL VERDICT

Score: {verdict["score"]}
Confidence: {verdict["confidence"]}
Strengths: {verdict["strengths"]}
Weaknesses: {verdict["weaknesses"]}
Red Flags: {verdict["red_flags"]}
